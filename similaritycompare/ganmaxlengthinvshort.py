...
with tf.variable_scope('Generator'):
    ...
    G_l2 = tf.layers.dense(G_in, 32, tf.nn.relu)
    G_l1 = tf.layers.dense(G_l2, 32, tf.nn.relu)
    G_out = tf.layers.dense(G_l1, number_of_useorders)               # making a orderlist from these random ideas
